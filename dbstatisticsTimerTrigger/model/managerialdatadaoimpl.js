...
function getTransformerDataByCellID(objInput, arrWhereKey, arrWhereValue, callback) {
    objdaoimpl.getDataFromCollection("DELTA_Transformer", arrWhereKey, arrWhereValue, function (err, objSelTransformerData) {
        if (err) {
            callback(err, null);
            return;
        }
...
function getCircuitByCircuitID(objInput, arrWhereKey, arrWhereValue, callback) {
    var objRowData = {};
    objdaoimpl.getDataFromCollection("DELTA_Circuit", arrWhereKey, arrWhereValue, function (err, objSelCircuitData) {
        if (err) {
            callback(err, null);
            return;
        }
...
function getHypersproutDataByCellID(objInput, arrWhereKey, arrWhereValue, callback) {
    try {
        objdaoimpl.getDataFromCollection("DELTA_Hypersprouts", arrWhereKey, arrWhereValue, function (err, objSelTransformerData) {
            if (err) {
                callback(err, null);
                return;
            }
...
function getMeterByMeterID(meterIdVal, callback) {
    ...
    objdaoimpl.getDataFromCollection("DELTA_Meters", objWhereKeys, meterIdVal, function (err, objSelMeterData) {
        if (err) {
            callback(err, null);
            return;
        }
