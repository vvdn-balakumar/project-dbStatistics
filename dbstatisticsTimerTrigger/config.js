...
objConfig.inputdatasource.username = null;
objConfig.inputdatasource.password = null;
objConfig.inputdatasource.admindatabase = process.env.adminDatabase;
objConfig.inputdatasource.admin = process.env.adminUsername;
objConfig.inputdatasource.adminpassword = process.env.adminPassword;
